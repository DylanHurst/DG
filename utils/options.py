...
def get_args():
    cfg = int(os.environ.get("CONFIG_MODULE", 0))  #set CONFIG_MODULE 0 ,1 or 2
    print("CONFIG_MODULE =", cfg)
    if cfg==0:
        parser = argparse.ArgumentParser(description="Improved IRRA")

        parser.add_argument("--noisy_rate", default=0, type=float)
        ...
        parser.add_argument("--prob", type=float, nargs="+", default=0.1)
        ######################## general settings ########################
        ...
        ######################## loss settings ########################
        parser.add_argument("--loss_names", default='GCL', help="which loss to use ['GCL', 'SDM','TRL']")
        ...
        parser.add_argument("--root_dir", default="D:\\save\\study\\datasets_save\\Cross-Modal-Person-ReID")
        ...
        parser.add_argument("--select_ratio", default=0.3, type=float)
        parser.add_argument("--margin", default=0.1, type=float)
        parser.add_argument("--prob", type=float, nargs="+", default=0.3)
        ######################## general settings ########################
        parser.add_argument("--local_rank", default=0, type=int)
        parser.add_argument("--name", default="baseline", help="experiment name to save")
        parser.add_argument("--output_dir", default="output")
        ...
        parser.add_argument("--alpha", type=float, default=0.9)
        parser.add_argument("--beta", type=float, default=0.999)
        parser.add_argument("--scale", type=float, nargs="+",  default=[0,10,0])
        parser.add_argument("--argc", type=float, nargs="+", default=[0.03,0.05,0.1])
